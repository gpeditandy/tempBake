<template>
	<view class="uni-date">
		...
		'uni-date-x--border': border}">
					<view v-if="!isRange" class="uni-date-x uni-date-single" :class="[padding?'uni-date-pad':'']">
					...
					<view v-else class="uni-date-x uni-date-range" :class="[padding?'uni-date-pad':'']">
						<uni-icons type="calendar" color="#e1e1e1" size="22"></uni-icons>
